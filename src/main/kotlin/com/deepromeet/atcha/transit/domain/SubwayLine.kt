...
enum class SubwayLine(
    ...
    LINE_2(listOf("수도권2호선(급행)", "수도권2호선", "2호선"), "2", isCircular = true),
    LINE_3(listOf("수도권3호선(급행)", "수도권3호선", "3호선"), "3"),
    LINE_4(listOf("수도권4호선(급행)", "수도권4호선", "4호선"), "4"),
    LINE_5(listOf("수도권5호선(급행)", "수도권5호선", "5호선"), "5"),
    LINE_6(listOf("수도권6호선(급행)", "수도권6호선", "6호선"), "6"),
    LINE_7(listOf("수도권7호선(급행)", "수도권7호선", "7호선"), "7"),
    LINE_8(listOf("수도권8호선(급행)", "수도권8호선", "8호선"), "8"),
    LINE_9(listOf("수도권9호선(급행)", "수도권9호선", "9호선"), "9"),
