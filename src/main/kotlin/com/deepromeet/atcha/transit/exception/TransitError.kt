...
enum class TransitError(
    ...
    TAXI_FARE_FETCH_FAILED(500, "TRS_002", "알수 없는 이유로 택시 요금 조회에 실패했습니다", LogLevel.WARN),
    TAXI_START_NOT_FOUND(400, "TRS_003", "출발지 주변에 도로가 없습니다. 다시 설정해주세요.", LogLevel.WARN),
    TAXI_SAME_LOCATION(400, "TRS_004", "출발지와 도착지가 같은 곳이에요. 다른 곳으로 설정해주세요.", LogLevel.WARN),
    NOT_FOUND_SUBWAY_STATION(404, "TRS_006", "지하철 역을 찾을 수 없습니다", LogLevel.WARN),
    NOT_FOUND_SUBWAY_ROUTE(404, "TRS_009", "지하철 노선을 찾을 수 없습니다", LogLevel.WARN),
    DISTANCE_TOO_SHORT(400, "TRS_011", "출발지와 도착지 간 거리가 너무 가깝습니다.", LogLevel.WARN),
    ...
    INVALID_TIME_FORMAT(400, "TRS_024", "유효하지 않은 시간 형식입니다.", LogLevel.WARN),
    BUS_TERM_REQUIRED(404, "TRS_026", "버스 배차간격은 필수 값입니다.", LogLevel.WARN)
}
